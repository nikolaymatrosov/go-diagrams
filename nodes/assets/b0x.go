// Code generated by fileb0x at "2020-09-25 22:49:51.47221 +0300 MSK m=+1.278771845" from config file "b0x.yml" DO NOT EDIT.
// modification hash(0c838110af91494259723d4b8b9fc65d.be89261af1c9c296ff68287d42ae713a)
...
func init() {
	...
	err = FS.Mkdir(CTX, "assets/yc/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/yc/serverless/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/yc/ml/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/yc/datastorage/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}

	err = FS.Mkdir(CTX, "assets/yc/infrastructure/", 0777)
	if err != nil && err != os.ErrExist {
		panic(err)
	}
